                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="yummyfood-nav">
                            <ul class="navbar-nav" id="yummy-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="static1.php" >Article 1 <span class="sr-only">(current)</span></a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="col-10 col-sm-11">
                            <div class="single-post">
                                ...
                                <div class="post-thumb">
                                    <img src="img/catagory-img/handball.jpg" alt="handball">
                                </div>
                                <!-- Post Content -->
                                <div class="post-content">
                                    ...
                                    <br>
                                    <br>
                                    Le hand est un sport mondialement connue surtout avec ces stars comme Nikola Karabatic , Mikel Hansen, Luc Abalo et encore plein d'autre stars qui peuvent faire des geste technique spectaculaire comme la roucoulette ou encore un kung-fu, mais tout cela passe par des seances d'entrainements pour pouvoir perfectionner soit leur performance individuel ou les tactiques mises en place.
 ...
 <!-- Single Widget Area -->
    ...
    <script type="application/ld+json">
      ...
      "itemListElement": [{
        ...
        "position": 1,
        "item": {
          "@id": "https://seo-projectb1.herokuapp.com/static1.php",
          "name": "Le Handball un sport incontournable !",
          "image": "img/blog-img/Handball.jpg"
        }
      },{
        "@type": "ListItem",
        "position": 2,
