...
<head>
    ...
    <!-- Title -->
    <title>Sport Blog - Article 2</title>
                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="yummyfood-nav">
                            <ul class="navbar-nav" id="yummy-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="static2.php">Article 2 <span class="sr-only">(current)</span></a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="col-10 col-sm-11">
                            <div class="single-post">
                                ...
                                <div class="post-content">
                                    ...
                                    <a href="#">
                                        <h2 class="post-headline">Jarvis remporte la Red Bull Romaniacs 2016</h2>
                                    </a>
                                    <p>Résultat historique à la quatorzième édition de la Red Bull Romaniacs. Ce week-end en
                                        Roumanie, Graham Jarvis est devenu le pilote le plus titré sur la célèbre course
                                        de Hard Enduro, en remportant pour la sixième fois l'épreuve. A 42 ans, le pilote
                                        a passé une semaine à l'attaque et distance son plus proche poursuivant Mario Roman
                                        de plus d'une demi-heure. Paul Bolton complète le podium avec une cinquantaine de
                                        minutes de retard.</p>
                                    ...
                                    <h4>Graham Jarvis triomphe au Red Bull Hare Scramble</h4>
                                    <p>Graham Jarvis a remporté son troisième Red Bull Hare Scramble. Et pas qu’un peu, puisqu’il
                                        l’a emporté de plus de trente minutes à l’Erzbergrodeo 2016. Le pilote Husqvarna
                                        s’est fait une place depuis la deuxième ligne d’où il partait et a rattrapé tout
                                        le monde, a dépassé tout le monde pour rejoindre le drapeau à damiers. Jarvis a géré
                                        sa course de manière impeccable sur le tracé d’une trentaine de kilomètres, en à
                                        peine plus de deux heures et vingt minutes.</p>
                                    <div class="embed-responsive embed-responsive-16by9">
                                        <iframe class="" width="560" height="315" src="https://www.youtube.com/embed/zDXYQVmX99Q?rel=0&amp;showinfo=0" frameborder="0"
